...
class plnLoss(nn.Module):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        #print("noo_mask",noo_mask_center.shape)
        ...
        return p_loss + self.w_coord * wcoord_loss + self.w_class * wclass_loss + self.w_link * wlink_loss + nooobj_loss * 0.04        #return p_loss + self.w_coord * wcoord_loss + self.w_class * wclass_loss + self.w_link * wlink_loss + nooobj_loss * 0.04